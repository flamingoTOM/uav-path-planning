...
print("正在使用 JPS 算法规划路径...")
print(f"起点: {start}, 终点: {goal}")

# 创建规划器并规划路径
planner = JPS(map_=map_, start=start, goal=goal)
...
# 可视化
vis = Visualizer("JPS Path Visualizer")
...
# 保存图片
output_path = "C:/Users/xiaoyu.liu/Desktop/my_project/uav-path-planning/pic/jps.png"
